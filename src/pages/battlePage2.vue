  ...
  export default {
    ...
    data() {
      return {
        ...
        carouselItems: [
          'http://qn.file.classmaster.cn/Carousel1.jpg-1080p',
          'http://qn.file.classmaster.cn/Carousel3.jpg-1080p',
          'http://qn.file.classmaster.cn/Carousel2.jpg-1080p',
          'http://qn.file.classmaster.cn/Carousel4.jpg-1080p',
        ],
      };
    },
    computed: {
